package th.go.dxc.infra.datasource.reference_db.config;
...
@EnableJpaRepositories(
    basePackages = ReferenceDbDatasourceConfig.BASE_PACKAGE, 
    entityManagerFactoryRef = ReferenceDbDatasourceConfig.DATASOURCE_BEAN_NAME+"EntityManagerFactory", 
    transactionManagerRef = ReferenceDbDatasourceConfig.DATASOURCE_BEAN_NAME+"TransactionManager"
)
public class ReferenceDbDatasourceConfig {
	// Configuration Required
	public final static String APP_ROOT_PACKAGE="th.go.dxc";
	public final static String DATASOURCE_PACKAGE_NAME = "reference_db";
	public final static String DATASOURCE_BEAN_NAME = "referenceDb";
	public final static String DATASOURCE_PROPERTIES_NAME = "reference-db";
	// Derived values
    ...
    public ReferenceDbDatasourceConfig() {
		super();
