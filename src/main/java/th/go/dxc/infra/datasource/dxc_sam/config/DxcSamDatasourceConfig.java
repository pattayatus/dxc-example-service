package th.go.dxc.infra.datasource.dxc_sam.config;
...
@EnableJpaRepositories(
    basePackages = DxcSamDatasourceConfig.BASE_PACKAGE, 
    entityManagerFactoryRef = DxcSamDatasourceConfig.DATASOURCE_BEAN_NAME+"EntityManagerFactory", 
    transactionManagerRef = DxcSamDatasourceConfig.DATASOURCE_BEAN_NAME+"TransactionManager"
)
public class DxcSamDatasourceConfig {
	// Configuration Required
	public final static String APP_ROOT_PACKAGE="th.go.dxc";
	public final static String DATASOURCE_PACKAGE_NAME = "dxc_sam";
	public final static String DATASOURCE_BEAN_NAME = "dxcSam";
	public final static String DATASOURCE_PROPERTIES_NAME = "dxc-sam";
	// Derived values
